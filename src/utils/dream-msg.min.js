...
!(function (global, factory) {
  ;(typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) ===
    ...
    ? define(factory)
    : ((global = global || self), (global.Dreamer = factory()))
})(void 0, function () {
  'use strict'
  ...
  function createMsgEl(args) {
    ...
    var el = c({ className: 'dream-msg-wrapper' }, [
      c({ className: 'dream-msg dream-msg-fade-in ' + type }, [
        c({ className: 'dream-msg-icon' }, iconObj[type]),
        c({ className: 'dream-msg-content' }, msg),
        c(
          {
            className:
              'dream-msg-wait ' + (closable ? 'dream-msg-pointer' : ''),
...
function errorSound() {
  ...
  audio.setAttribute(
    'src',
    'https://cdn.jsdelivr.net/gh/iGaoWei/Dream-Msg/lib/wav/tip.mp3'
  )
